        ...
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-2 p-1 rounded-lg">
              <Button
                variant={viewMode === "edit" ? "default" : "glass"}
                size="sm"
                onClick={() => onViewModeChange("edit")}
                className="text-xs rounded-xl p-0 h-9 w-24 flex items-center justify-center shadow-md"
              >
                <Edit3
                  size={16}
                  className={`mr-2 ${viewMode === "edit" ? "text-white" : ""}`}
                />
                Edit
              </Button>
              <Button
                variant={viewMode === "present" ? "default" : "glass"}
                size="sm"
              ...
              >
                <Eye
                  size={16}
                  className={`mr-2 ${viewMode === "present" ? "text-white" : ""}`}
                />
                View
              </Button>
            </div>
